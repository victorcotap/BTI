...
-- A2GDetection = DETECTION_AREAS:New(A2GDetectionGroups, 800):SetRefreshTimeInterval(20)

-- A2GDispatcher = AI_A2G_DISPATCHER:New(A2GDetection)
-- A2GDispatcher:SetDefenseRadius( 50000 )
-- A2GDispatcher:SetIntercept(10)
...
-- A2GDispatcher:SetSquadron(SEADSquadron, AIRBASE.PersianGulf.Bandar_Lengeh, { SEADSquadron }, 10 )
-- A2GDispatcher:SetSquadronSead(SEADSquadron, UTILS.KnotsToMps(250), UTILS.KnotsToMps(450))

-- local BAISquadron = "BLUE D BAI"
-- A2GDispatcher:SetSquadron(BAISquadron, AIRBASE.PersianGulf.Bandar_Lengeh, { BAISquadron }, 10 )
-- A2GDispatcher:SetSquadronBai(BAISquadron, UTILS.KnotsToMps(350), UTILS.KnotsToMps(550))

-- local CASSquadron = "BLUE D CAS"
-- A2GDispatcher:SetSquadron( CASSquadron, AIRBASE.PersianGulf.Bandar_Lengeh, { CASSquadron }, 10 )
